...
let_expr:
',' OBJECTID ':' TYPEID let_expr {$$ = let($2, $4, no_expr(), $6);} /* Double check this */
| ',' OBJECTID ':' TYPEID ASSIGN expr let_expr { $$ = let($2, $4, $6, $8);}
| error {};
...
| LET OBJECTID ':' TYPEID let_expr IN expr {}
| LET OBJECTID ':' TYPEID ASSIGN expr let_expr IN expr {}
